#include "D:\\LR&JMETER2023 Scripts\\LR2023\\JPetstore\\JessicaReusable_ModularApproachCode.txt"
Action()
{
...
//        lr_end_transaction("Petstore_SC01_TS03_EntertoLogin",LR_PASS);
//        }
//     else{
//          lr_error_message("Text not found.");
//          lr_end_transaction("Petstore_SC01_TS03_EntertoLogin",LR_FAIL);
//          return(0);
//     }
