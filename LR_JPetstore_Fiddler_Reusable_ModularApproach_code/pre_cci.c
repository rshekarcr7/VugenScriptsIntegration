# 1 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c"
...
# 1 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
...
# 2 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
...
# 3 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
...
# 4 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
...
Action()
{
	...
	launch();
		...
		if (atoi(lr_eval_string("{StoreCount}")) > 0){
        lr_output_message("Text found.");
        lr_end_transaction("WB_SC01_T01_Launch",0);
        }
     else{
          lr_error_message("Text not found.");
          lr_end_transaction("WB_SC01_T01_Launch",1);
          return(0);
     }
	...
	if (atoi(lr_eval_string("{StoreCount}")) > 0){
        lr_output_message("Launch successful.");
        }
     else{
	...
	web_url("Sign In", 
		...
		lr_end_transaction("Petstore_SC01_TS02_EntertheStore", 2);
	...
	web_url("sm_fish.gif", 
		...
		lr_end_transaction("Petstore_SC01_TS04_clickonPet", 2);
	...
	web_url("FI-SW-01", 
		...
		lr_end_transaction("Petstore_SC01_TS05_clickonProductID", 2);
	...
	web_url("EST-1", 
		...
		lr_end_transaction("Petstore_SC01_TS06_clickonItemID", 2);
		web_reg_find("Search=Body",
	...
	web_url("Add to Cart", 
		...
		lr_end_transaction("Petstore_SC01_TS07_clickonAddtoCart", 2);
		web_reg_find("Search=Body",
		"SaveCount=Count",
		"Text=FI-SW-01",
		"LAST");
	...
	web_url("Proceed to Checkout", 
		...
		lr_end_transaction("Petstore_SC01_TS08_proceedtoCheck", 2);
	...
	lr_end_transaction("Petstore_SC01_TS09_EnterPaymentDetails", 2);
	web_reg_find("Search=Body",
	...
	web_url("Confirm", 
		...
		lr_end_transaction("Petstore_SC01_TS10_ConfirmOrder", 2);
		web_reg_find("Search=Body",
...
# 5 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
...
# 6 "d:\\lrjmeterscriptnew\\lrfilespass\\jpetstore\\lr_jpetstore_fiddler_reusable_modularapproach_code\\\\combined_LR_JPetstore_Fiddler_Reusable_ModularApproach_code.c" 2
